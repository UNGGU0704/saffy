...
<%@ include file="nav/nav.jsp" %>
	<div
		...
		<form id="registForm" method="post" action="${root}/regist">
			...
			<input type="text" id="productCode" name="code" placeholder="고유번호 입력" required="required"> 
			<label for="model">모델명</label> 
			<input type="text" id="model" name="model" placeholder="모델명 입력" required="required"> 
			<label for="price">가격</label>
			<input type="number" id="price" name="price" placeholder="가격 입력" required="required"> 
