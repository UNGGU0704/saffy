...
//		TODO : Service의 registerArticle을 호출하세요!!!
		BoardServiceImpl.getBoardServiceImpl().registerArticle(boardDto);
//		END
	}
...
//		TODO : Service의 searchListAll을 호출하세요!!!
		...
		list = BoardServiceImpl.getBoardServiceImpl().searchListAll();
//		END
...
//		TODO : Service의 searchListBySubject을 호출하세요!!!
		...
		list = BoardServiceImpl.getBoardServiceImpl().searchListBySubject(subject);
//		END
...
//		TODO : Service의 viewArticle을 호출하세요!!!
		BoardDto boardDto = BoardServiceImpl.getBoardServiceImpl().viewArticle(no);
//		END		
...
//		TODO : Service의 modifyArticle을 호출하세요!!!
		...
		BoardServiceImpl.getBoardServiceImpl().modifyArticle(boardDto);
...
//		TODO : Service의 deleteArticle을 호출하세요!!!
		BoardServiceImpl.getBoardServiceImpl().deleteArticle(no);
//		END
	}
